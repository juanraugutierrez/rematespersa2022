Public Class remates
    ...
    Private Sub LoteoDesatendidoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LoteoDesatendidoToolStripMenuItem.Click
        verifica()
        Frm_loteoDesatendido.MdiParent = Me
        Frm_loteoDesatendido.Show()
    End Sub
End Class
